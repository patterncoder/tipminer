...
function createDefaultContracts() {
    Contract.find({}).exec(function(err, collection){
        ...
        if(collection.length===0){
            ...
            Contract.create({name:'Clark Party', date:'3/6/1965', contract:true, nature:'Plated Dinner', tags:['nice customer','repeat visit']})
            ...
            Contract.create({name:'Roberts Party', date:'6/6/1963', contract:true, nature:'Plated Dinner', tags:['nice customer','repeat visit']})
            ...
            Contract.create({name:'Bush Party', date:'9/6/1961', contract:true, nature:'Plated Dinner', tags:['nice customer','repeat visit']})
            ...
            Contract.create({name:'Washington Party', date:'12/6/1961', contract:true, nature:'Plated Dinner', tags:['nice customer','repeat visit']})
        }
    })
}
